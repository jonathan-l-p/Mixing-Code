...
ReactionRate2 = readfromfortran('out_ReactionRate2.bin',Ny,Nx);

% fine mesh data
ReactionRate2_fine = readfromfortran('out_ReactionRate2_fine.bin',Ny,Nx);
hStar_fine = readfromfortran('out_hStar_fine.bin',Ny,Nx);
Y1_fine = readfromfortran('out_Y1_fine.bin',Ny,Nx);
Y2_fine = readfromfortran('out_Y2_fine.bin',Ny,Nx);
T_fine = readfromfortran('out_T_fine.bin',Ny,Nx);
