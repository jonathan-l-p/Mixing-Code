...
module global
  ...
  integer, parameter :: x0ind = 5001 ! ceiling(real(Nx)/7.d0) ! index of xStar where \kappa*_{\infinity}(x) switches from a constant to a function of 1 / sqrt{x}
  ...
  real(dp) :: FSR_h = 1.0d0 ! h_{\infinity} / h_{-\infinity}
